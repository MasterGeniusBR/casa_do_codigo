...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/casa_do_codigo$1.0.0/src/app/views/livros/formulario/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  if (data.livro.id) {
    out.w("<div><input type=\"hidden\" value=\"" +
      marko_escapeXmlAttr(data.livro.id) +
      "\" id=\"id\" name=\"id\"><input type=\"hidden\" id=\"_method\" name=\"_method\" value=\"PUT\"></div>");
  }
...
marko_template.meta = {
    id: "/casa_do_codigo$1.0.0/src/app/views/livros/formulario/form.marko",
    tags: [
